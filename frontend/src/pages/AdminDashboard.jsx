...
import { 
  ...
  Send, Trash2, ShieldCheck, AlertCircle, Database, Tent 
} from 'lucide-react';
...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    fetchAdminData();
    fetchBroadcasts();
    // Real-time monitoring: 10 seconds refresh
  ...
  const sendBroadcast = async () => {
    ...
    if(res.ok) {
      setBroadcastMsg("");
      fetchBroadcasts();
      alert("Emergency Alert Dispatched Globally! 📢");
    }
  };

  // 4. Delete Specific Broadcast
